...
const REASONS = [
  {
    ...
    description:
      "Học viện Quân y là nơi đào tạo những bác sĩ quân y hàng đầu, với chương trình giảng dạy chất lượng cao và đội ngũ giảng viên giàu kinh nghiệm.",
    icon: (
      <SchoolIcon sx={{ color: "#21593b", fontSize: { xs: 80, md: 40 } }} />
    ),
  ...
  },
  {
    ...
    description:
      "Sinh viên tốt nghiệp tại Cao đẳng hậu cần có cơ hội làm việc tại các cơ quan y tế quân đội, bệnh viện, và các tổ chức y tế quốc tế.",
    icon: (
      <SchoolIcon sx={{ color: "#21593b", fontSize: { xs: 80, md: 40 } }} />
    ),
  ...
  },
  {
    ...
    description:
      "Học viện có các phòng học, phòng thí nghiệm, và cơ sở vật chất hiện đại, đáp ứng đầy đủ nhu cầu học tập và nghiên cứu của sinh viên.",
    icon: (
      <ScienceIcon sx={{ color: "#21593b", fontSize: { xs: 80, md: 40 } }} />
    ),
    ...
    post: [
      {
        ...
        excerpt:
          "Học viện Quân y thông báo chỉ tiêu tuyển sinh hệ đại học chính quy năm 2024 với 5 ngành đào tạo trọng điểm. Đây là cơ hội để các bạn thí sinh theo học các ngành Y khoa, Dược học, Kỹ thuật y học, Quân y, và Điều dưỡng tại một trong những trường đại học hàng đầu.",
      },
      {
        ...
        excerpt:
          "Cập nhật mới nhất về các phương thức xét tuyển đại học hệ chính quy năm 2024 tạiCao đăng hậu cần. Các phương thức bao gồm xét kết quả thi tốt nghiệp THPT, xét học bạ, và thi đánh giá năng lực. Đặc biệt, Học viện cung cấp nhiều chương trình học bổng cho sinh viên xuất sắc.",
      },
      {
        ...
        excerpt:
          "Tổng hợp thông tin các ngành đào tạo và điểm chuẩn 3 năm gần nhất để thí sinh tham khảo. Các ngành đào tạo chính củaCao đăng hậu cần bao gồm Y khoa, Dược học, Điều dưỡng, Quân y, và các ngành kỹ thuật y học. Điểm chuẩn và tỷ lệ chọi qua các năm có sự biến động lớn.",
      },
      {
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdKSGGnDEkdZY418FphDacR55QbWX_ZIceFg&s",
        name: "Lịch thi tuyển sinh đại học năm 2024",
        excerpt:
          "Lịch thi tuyển sinh đại học đợt 1 năm 2024 sẽ được tổ chức vào tháng 7. Các thí sinh cần chú ý các mốc thời gian quan trọng như ngày nhận hồ sơ, ngày thi, và ngày công bố kết quả.",
      },
    ],
  },
  {
    ...
    post: [
      {
        ...
        excerpt:
          "Học viện Quân y thông báo tuyển sinh hệ cao đẳng chính quy năm 2024 với các ngành đào tạo như Kỹ thuật Y học, Điều dưỡng, và Y tá. Hệ cao đẳng này cung cấp chương trình học chất lượng cao, cơ hội thực tập tại các bệnh viện lớn.",
      },
      {
        ...
        excerpt:
          "Các phương thức xét tuyển vào hệ cao đẳng năm 2024 bao gồm xét học bạ, thi tuyển sinh và thi đánh giá năng lực. Các thí sinh cần chuẩn bị đầy đủ hồ sơ và chú ý đến hạn nộp hồ sơ.",
      },
      {
        img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
        name: "Điều kiện và tiêu chí xét tuyển cao đẳng",
        excerpt:
          "Điều kiện xét tuyển hệ cao đẳng chính quy 2024 bao gồm: hoàn thành chương trình THPT hoặc tương đương, có sức khỏe tốt và có kết quả thi đạt yêu cầu.Cao đăng hậu cần luôn đảm bảo chất lượng đầu ra của sinh viên.",
      },
      {
        ...
        excerpt:
          "Thời gian đào tạo hệ cao đẳng tạiCao đăng hậu cần là 3 năm, với các kỳ thi chính vào cuối mỗi năm học. Chương trình học bao gồm lý thuyết, thực hành, và các buổi học ngoại khóa tại các bệnh viện thực hành.",
      },
    ],
  },
  {
    ...
    post: [
      {
        ...
        excerpt:
          "Thông báo tuyển sinh hệ cao học đợt 1 năm 2024 với các chuyên ngành như Y tế công cộng, Quản lý bệnh viện, Kỹ thuật y học. Đây là cơ hội để các bạn học viên nâng cao trình độ chuyên môn.",
      },
      {
        img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
        name: "Thông báo tuyển sinh nghiên cứu sinh năm 2024",
        excerpt:
          "Kế hoạch tuyển sinh nghiên cứu sinh năm 2024 tạiCao đăng hậu cần. Các ngành tuyển sinh bao gồm Y khoa, Dược học, Điều dưỡng, Kỹ thuật y học, và nhiều ngành khác. Quy trình xét tuyển và hồ sơ yêu cầu sẽ được cập nhật chi tiết.",
      },
      {
        img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
        name: "Danh mục các chuyên ngành đào tạo sau đại học",
        excerpt:
          "Danh sách các chuyên ngành đào tạo trình độ thạc sĩ, tiến sĩ tạiCao đăng hậu cần. Các ngành bao gồm các lĩnh vực nghiên cứu như Y học lâm sàng, Y tế công cộng, Quản lý bệnh viện, và nghiên cứu khoa học y tế.",
      },
      {
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdKSGGnDEkdZY418FphDacR55QbWX_ZIceFg&s",
        name: "Thông tin về học bổng và hỗ trợ nghiên cứu",
        excerpt:
          "Học viện Quân y cung cấp nhiều loại học bổng và hỗ trợ nghiên cứu cho sinh viên, nghiên cứu sinh, và học viên cao học. Các chương trình học bổng này nhằm khuyến khích nghiên cứu khoa học và đổi mới sáng tạo.",
      },
    ],
  },
];
...
const EVENTS = [
  {
    name: "Lịch thi tuyển sinh đại học đợt 1 năm 2024",
    date: "15/06/2024",
    location: "Hội trường lớn",
  },
  {
    name: "Hội thảo tư vấn tuyển sinh trực tuyến",
    date: "25/05/2024",
    location: "Trực tuyến",
  },
  {
    name: "Ngày hội tư vấn tuyển sinh tại Học viện",
    date: "10/05/2024",
    location: "Sân vận động",
  },
  {
    name: "Công bố điểm chuẩn xét tuyển sớm",
    date: "30/06/2024",
    location: "Website HVQY",
  },
  {
    name: "Chương trình open day cho học sinh THPT",
    date: "05/05/2024",
    location: "Toàn Học viện",
  },
  {
    name: "Thời hạn nộp hồ sơ xét tuyển đại học",
    date: "30/05/2024",
...
const SCIENCE = [
  ...
  },
  {
    ...
    excerpt:
      "Nghiên cứu phát triển vắc-xin phòng các bệnh truyền nhiễm nguy hiểm",
  },
  {
    ...
    excerpt:
      "Nghiên cứu ứng dụng kỹ thuật xâm lấn tối thiểu trong phẫu thuật tim",
  },
];
...
const LOGO = [
  {
    ...
    description:
      "Bệnh viện đa khoa hạng I, là cơ sở thực hành chính của Học viện",
  },
  {
  ...
  return (
    <Box sx={{ bgcolor: "#f5f5f7" }}>
        ...
        >
          <Box sx={{ height: "60vh" }}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ mt: 2, fontSize: "1rem" }}>
                Cao đăng hậu cần thông báo tuyển sinh các hệ đào tạo năm học
                2024-2025
              </Typography>
              <Button
                variant="contained"
          ...
          <Box sx={{ height: "60vh" }}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ mt: 2, fontSize: "1rem" }}>
                Nhiều phương thức xét tuyển linh hoạt, phù hợp với nhiều đối
                tượng thí sinh
              </Typography>
              <Button
                variant="contained"
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="body1">
                      ...
                      {index === 1 &&
                        "Nhấn đăng ký nếu chưa có tài khoản, nếu đã có tài khoản bạn đăng nhập để nộp hồ sơ"}
                      {index === 2 &&
                        "Thực hiện các bước theo hướng dẫn để nộp hồ sơ vào Trường Cao đẳng Hậu cần"}
                    </Typography>
                  </Box>
                </Box>
              ))}
      ...
      <Container maxWidth="xl" sx={{ py: 6 }}>
          ...
          >
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="body1" sx={{ mb: 2, fontSize: "1.1rem" }}>
                Cao đăng hậu cần là cơ sở đào tạo y khoa hàng đầu của Quân đội
                với hơn 70 năm xây dựng và phát triển, chương trình đào tạo đạt
                chuẩn quốc tế, cơ sở vật chất hiện đại.
              </Typography>
              <List sx={{ mb: 3 }}>
              ...
              {HIGHTLIGHT_NEWS.map((item, index) => (
                <Chip
                  ...
                  sx={{
                    ...
                    fontSize: "1rem",
                    backgroundColor:
                      selectedIndex === index ? "#21593b" : "#f0f0f0",
                    color: selectedIndex === index ? "white" : "black",
                    "&:hover": {
                      backgroundColor:
                        selectedIndex === index ? "#184328" : "#e0e0e0",
                    },
                    cursor: "pointer",
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        variant="body2"
                        color="text.secondary"
                        sx={{ mb: 2, fontSize: { xs: "1.5rem", md: "1rem" } }}
                      >
                        {post.excerpt}
                      </Typography>
                      <Stack
                      ...
                      >
                        ...
                        <Typography variant="body2">05/04/2024</Typography>
                      </Stack>
                      <Box sx={{ mt: "auto" }}>
                        <Button
                          variant="contained"
        ...
        <Paper
          elevation={6}
          sx={{ p: { xs: 3, md: 5 }, mb: 10, borderRadius: 4 }}
        >
          <Stack
            direction={{ xs: "column", md: "row" }}
          ...
          <Box maxWidth="1500px">
            <Typography
              variant="body1"
              color="text.secondary"
              sx={{ fontSize: "1.3rem", marginLeft: "60px" }}
            >
              Cao đăng hậu cần là một trung tâm Đào tạo, Nghiên cứu khoa học và
              Điều trị lớn của quân đội. Trải qua quá trình xây dựng và trưởng
              thành, Nghiên cứu khoa học của Học viện đã đạt được những thành
              tựu đáng tự hào.
            </Typography>
          </Box>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  >
                    ...
                    >
                      Vui lòng kiểm tra email và SMS sau khi đăng ký để nhận
                      thông tin tư vấn.
                    </Typography>
                  </Box>
                </Grid>
